...
let prom0 = obtainInstruction("brusselsSprouts", 0)
let prom1 = obtainInstruction("brusselsSprouts", 1)
let prom2 = obtainInstruction("brusselsSprouts", 2)
let prom3 = obtainInstruction("brusselsSprouts", 3)
let prom4 = obtainInstruction("brusselsSprouts", 4)
let prom5 = obtainInstruction("brusselsSprouts", 5)
let prom6 = obtainInstruction("brusselsSprouts", 6)
let prom7 = obtainInstruction("brusselsSprouts", 7)
let prom8 = "Brussels sprouts are ready!"


Promise.all([prom0, prom1, prom2, prom3, prom4, prom5, prom6, prom7, prom8])
.then(()=>{
